...
#SBATCH --output=/leonardo_work/EUHPC_A05_043/TFG_pjardi/outputs/FCD_cosine_8M_external_datasets-%j.out
#SBATCH --time=00:30:00
#SBATCH --error=/leonardo_work/EUHPC_A05_043/TFG_pjardi/outputs/FCD_cosine_8M_external_datasets-%j.err
#SBATCH --nodes=1
...
python3 FCD_embeddings_external_datasets.py
