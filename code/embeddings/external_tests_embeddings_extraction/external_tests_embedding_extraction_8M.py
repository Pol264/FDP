...
esm_path = "/leonardo_work/EUHPC_A05_043/TFG_pjardi/models/esm2_t6_8M_UR50D.pt"
...
if __name__ == '__main__':
    ...
    for name, path in datasets.items():
        ...
        np.savez_compressed(f"/leonardo_work/EUHPC_A05_043/TFG_pjardi/datasets_prove_metrics/embeddings_{name}_8M.npz", embeddings=embeddings)
