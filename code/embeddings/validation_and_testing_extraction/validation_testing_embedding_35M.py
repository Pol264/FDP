...
state_dict = torch.load("/leonardo_work/EUHPC_A05_043/TFG_pjardi/models/35M_model.pth", map_location="cpu")
...
if __name__ == '__main__':
    ...
    for name, path in datasets.items():
        ...
        np.savez_compressed(f"/leonardo_work/EUHPC_A05_043/TFG_pjardi/uniref50_dataset/embeddings_35M_our_model_validation_and_testing/embeddings_{name}.npz", embeddings=embeddings)
