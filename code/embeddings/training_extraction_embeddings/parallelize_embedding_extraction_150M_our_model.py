...
def worker(rank, world_size, data_path, output_dir, repr_layer, batch_size, start_idx, end_idx, job_idx):
    ...
    model = ESM2(num_layers=30, embed_dim=640, attention_heads=20, alphabet=alphabet)
    #checkpoint = torch.load("/leonardo_work/EUHPC_A05_043/TFG_pjardi/models/150M_epoch_1.pt", map_location="cpu")
