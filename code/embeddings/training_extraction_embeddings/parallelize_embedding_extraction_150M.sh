...
OUTPUT_DIR="/leonardo_scratch/large/userexternal/pjardiya/embeddings/embeddings_150M_our_model_normal"
TOTAL_SEQS=67791787  # total sequences in dataset
N_JOBS=10  # Adjust total number of parallel jobs
JOB_IDX=${SLURM_ARRAY_TASK_ID}

python parallelize_embedding_extraction_pol_150M.py \
    --data_path $DATA_PATH \
