...
srun python3 esm2_job_splitter_8M.py \
    --job_id $SLURM_ARRAY_TASK_ID \
    --total_jobs 10 \
    --fasta "/leonardo_work/EUHPC_A05_043/TFG_pjardi/uniref50_dataset/uniref50_without_validation_sequences.fasta.gz" \
    --epochs_per_job 3 \
    --model_path "/leonardo_work/EUHPC_A05_043/TFG_pjardi/models/8M.pt" \
    --checkpoint_path "/leonardo_work/EUHPC_A05_043/TFG_pjardi/checkpoints/8M_checkpoints/checkpoint.pth" \
    --log_file "/leonardo_work/EUHPC_A05_043/TFG_pjardi/logs/training_log_8M_oficial.txt"
