...
esm_model = ESM2(num_layers=30, embed_dim=640, attention_heads=20, alphabet=alphabet)
state_dict = torch.load("/leonardo_work/EUHPC_A05_043/TFG_pjardi/models/150M_epoch_1.pt", map_location="cpu")
...
if __name__ == '__main__':
    ...
    for name, path in datasets.items():
        ...
        np.savez_compressed(f"/leonardo_work/EUHPC_A05_043/TFG_pjardi/uniref50_dataset/embeddings_150M_our_model_validation_and_testing/embeddings_{name}.npz", embeddings=embeddings)
